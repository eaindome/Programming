<script lang="ts">
  ...
  import Logo from '../../../(auth)/components/ui/Logo.svelte';
  ...
  //       { label: 'Batches', href: '/industry/batches', icon: 'package' },
  //       { label: 'New Batch', href: '/industry/new-batch', icon: 'plus-circle' },
  //       { label: 'Recalls', href: '/industry/recalls', icon: 'alert-triangle' },
  //       { label: 'Transactions', href: '/industry/transactions', icon: 'list' },
  //     ];
  //   } else if (data?.user?.role === 'intermediary') {
  //     navItems = [
  //       { label: 'Dashboard', href: '/intermediary', icon: 'home' },
  //       { label: 'Inventory', href: '/intermediary/inventory', icon: 'box' },
  //       { label: 'Incoming', href: '/intermediary/incoming', icon: 'download' },
  //       { label: 'Outgoing', href: '/intermediary/outgoing', icon: 'upload' },
  //       { label: 'History', href: '/intermediary/history', icon: 'clock' },
  //     ];
  ...
  //       { label: 'Issues', href: '/admin/issues', icon: 'alert-circle' },
