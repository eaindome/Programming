def count_active_cubes(initial_state, cycles):
    # Create a set to store the active cubes (x, y, z)
    active_cubes = set()
...
# Calculate the number of active cubes after the specified number of cycles
result = count_active_cubes(initial_state, cycles)
print(f"Initial state: {initial_state}")
print("Number of active cubes after", cycles, "cycles:", result)
