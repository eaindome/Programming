...
from pharmacy.dependencies.database import Database, AnnotatedUser, get_inventory_or_404 #AnnotatedCartItem
...
#rom pharmacy.schemas.cart_items import CartItemCreate, CartItemSchema
