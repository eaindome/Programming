...
# Hint 13: Create a function called compare() and pass in user_score and computer_score. If
# the computer and user both have the same score, then it's a draw. If the computer has a 
# blackjack (0), then the user loses. If the uer has a blackjack (0), then the user wins. If the 
# user_score is over 21, then the user loses. If teh computer_score is over 21, then the computer loses.
