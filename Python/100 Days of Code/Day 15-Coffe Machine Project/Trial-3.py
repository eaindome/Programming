...
profit = 0
interest = input("What would you like? (espresso/latte/cappuccino): ")
print(f"{interest} water: {MENU[f'{interest}']['ingredients']['water']}")
print(f"{interest} milk: {MENU[f'{interest}']['ingredients']['milk']}")
print(f"{interest} coffe: {MENU[f'{interest}']['ingredients']['coffee']}\n")

profit = MENU[f'{interest}']['cost']
resource = remaining_resource(resources, interest, MENU)
report(resource, profit)
#print(MENU[f'{interest}']['ingredients'])
