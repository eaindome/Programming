...
-- Create ClassStatus table
CREATE TABLE ClassStatus (
  class_status_id SERIAL PRIMARY KEY,
...
-- Alter ClassStatus table to add a unique constraint
ALTER TABLE ClassStatus
ADD CONSTRAINT uk_classstatus_timetable_id UNIQUE (timetable_id);